...
Track active and upcoming work items. See [ROADMAP.md](ROADMAP.md) for longer-term plans.

## v1.1.x

- [x] Electron desktop app with React UI
- [x] Multi-provider metadata search
- [x] Apply Tags modal popup
...
- [x] Replace Python script with Electron app
- [x] Folder batch open with sidebar
- [x] `.env` and Settings API key management
- [x] Selectable metadata providers
